...
This is useful for zero-copy I/O pipelines, where a buffer may be borrowed from a caller, shared
with a cache, or handed to a store, and you would rather not copy it to move between those states.
